...
pub enum AuditEventPath {
    ...
    HooksEnable,
    CheckCompleted,
    /// An operator accepted specific detections into the baseline.
    BaselineAcceptance,
    SelfCheck,
    TestAlert,
    Attestation,
...
impl AuditEventPath {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::BaselineAcceptance => "vigil:baseline_acceptance",
    ...
    pub fn parse(s: &str) -> Option<Self> {
        match s {
            ...
            "vigil:baseline_acceptance" => Some(Self::BaselineAcceptance),
...
mod tests {
    ...
    fn audit_event_path_round_trip() {
        let variants = [
            ...
            AuditEventPath::BaselineAcceptance,
